...
{
	//RemoveBuildingForPlayer(playerid, 6391, 280.297, -1606.2, 72.3984, 250.0); // Building (now hardcoded in SA-MP)
	//RemoveBuildingForPlayer(playerid, 6394, 280.297, -1606.2, 72.3984, 250.0); // LOD (uncomment if you want the building LOD removed)
	//RemoveBuildingForPlayer(playerid, 6518, 280.297, -1606.2, 72.3984, 250.0); // Night Lights (Uncomment if you want the building lights removed)
...
public OnFilterScriptInit()
{
    ...
    for (new i = 0; i < MAX_PLAYERS; i++)
    {
        ...
        {
            RemoveNeededBuildingsForPlayer(i);
        }
    }
